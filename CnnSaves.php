    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="CnnSaves.php">CNN Saves</a></li>
            </ul>
        </div>
    </nav>

    <?php
        $cnnFile = simplexml_load_file("CnnSave.xml");
        ...
        function feedStart()
        {
            ...
            echo "<h3 style='margin-left: 20px;'>Current CNN Saves</h3>";
