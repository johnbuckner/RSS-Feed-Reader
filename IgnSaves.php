...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="IgnSaves.php">IGN Saves</a></li>
    ...
    <?php
        $ignFile = simplexml_load_file("IgnSave.xml");
        ...
        function feedStart()
        {
            ...
            echo "<h3 style='margin-left: 20px;'>Current IGN Saves</h3>";
