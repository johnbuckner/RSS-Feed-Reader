...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="IgnRssReader.php">IGN Feed</a></li>
    ...
    <?php
        ...
        {
            global $ignFile;
            $title = $ignFile->channel->title;
            $titleImage = $ignFile->channel->image->url;

            echo "<div style='margin-left: 35%; margin-bottom: 20px; margin-top: 80px'>";
        ...
        {
            global $ignFile;
            $titleLink = $ignFile->channel->link;
        ...
        function displayItems()
        {
            ...
            {
                echo "<form action='saveIgnArticle.php' method='POST'>";
                echo "<div class='container' style='margin-left: 4px; margin-bottom: 5px'>";
                    echo "<div style=''>";
